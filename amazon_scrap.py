...
df = pd.DataFrame({'product_name': product_names_df, 'price (INR)': product_prices_df, 'rating': ratings_df,
                   'product_page': main_page_urls_df})
print(df.head())
